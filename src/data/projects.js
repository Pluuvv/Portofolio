...
export const projects = [
  {
    ...
    screenshots: [
      { src: p("dine/Slide-1.jpg"), caption: "Overview" },
      { src: p("dine/Slide-2.jpg"), caption: "Features" },
      { src: p("dine/Slide-3.jpg"), caption: "UI Design" },
      { src: p("dine/Slide-4.jpg"), caption: "Architecture" },
      { src: p("dine/Slide-5.jpg"), caption: "Demo" },
    ],
    color: "#3B82F6",
    accentColor: "blue",
