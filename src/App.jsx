    ...
    >
      ...
      >
        ...
        <div className="text-center">
          <h1 className="font-display font-black text-2xl tracking-tight">Yanuar Arifin Ilham</h1>
...
function CustomCursor({ mousePos }) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      dotCurrent.current.x = lerp(dotCurrent.current.x, dotTarget.current.x, 0.9)
      dotCurrent.current.y = lerp(dotCurrent.current.y, dotTarget.current.y, 0.9)
      ringCurrent.current.x = lerp(ringCurrent.current.x, ringTarget.current.x, 0.12)
      ringCurrent.current.y = lerp(ringCurrent.current.y, ringTarget.current.y, 0.12)
