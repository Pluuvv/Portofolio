...
import { ArrowDown, Download, MapPin, Briefcase, Target, CheckCircle2 } from 'lucide-react'
import { useRef } from 'react'
import MagneticButton from '../ui/MagneticButton'

// Word-by-word animation for headline
const words = ["Designing", "Digital", "Experiences", "That", "Actually", "Work."]
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full glass border border-white/10 text-sm w-fit">
              ...
              <span className="text-white/65 font-medium">Available for opportunities</span>
            </div>
          </motion.div>
            ...
            >
              {words.map((word, i) => (
                <motion.span
                  ...
                  transition={{ duration: 0.9, delay: 0.7 + i * 0.1, ease: [0.34, 1.56, 0.64, 1] }}
          ...
          >
            Information Systems student at UPN Veteran Jakarta (GPA 3.86). Building native Android apps,
            full-stack web systems, and IoT architectures — while leading BEM FIK UPNVJ as Vice Chairperson.
          </motion.p>
          ...
          >
            {statusItems.map(({ icon: Icon, label, value, color }) => (
              ...
              >
                ...
                <span className="text-sm font-semibold text-white/90 leading-snug">{value}</span>
              </div>
            ))}
          </motion.div>
        </motion.div>
          ...
          */}
          ...
          >
            ...
            <div
              ...
              style={{ boxShadow: '0 0 40px rgba(59,130,246,0.12), 0 32px 64px rgba(0,0,0,0.5)' }}
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentNode.style.background = 'linear-gradient(160deg, #0f0f0f 0%, #1a1a2e 100%)'
                }}
              />
